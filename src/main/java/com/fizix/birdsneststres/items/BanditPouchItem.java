...
public class BanditPouchItem extends Item
{
    private static final ResourceLocation LOOT_TABLE = new ResourceLocation("birdsneststres:banditpouch_loot");
    private static final Logger LOGGER = LogManager.getLogger();


    public BanditPouchItem(String name)
    {
        super(new Properties()
                .maxStackSize(BirdsNestsTres.banditPouchStackSize)
